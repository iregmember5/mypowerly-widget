        ...
        <div style={{
              ...
              <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                ...
                <div>
                  ...
                  <Input
                    ...
                    placeholder="Ref no/phone/email of the person who referred you"
                    disabled={loading}
                    style={{ width: '100%' }}
                  />
                </div>
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
              ...
              <div>
                <div style={{ fontSize: '12px', fontWeight: 600, color: '#1f2937', lineHeight: 1.2 }}>Ahmad Malik's Tax Pro</div>
                <div style={{ fontSize: '10px', color: '#6b7280' }}>Tax Services</div>
              </div>
            </div>
